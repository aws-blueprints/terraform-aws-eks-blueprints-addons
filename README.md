...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_argo_events"></a> [argo\_events](#module\_argo\_events) | aws-blueprints/eks-blueprints-addon/aws | 2.0.0 |
| <a name="module_argo_rollouts"></a> [argo\_rollouts](#module\_argo\_rollouts) | aws-blueprints/eks-blueprints-addon/aws | 2.0.0 |
| <a name="module_argo_workflows"></a> [argo\_workflows](#module\_argo\_workflows) | aws-blueprints/eks-blueprints-addon/aws | 2.0.0 |
| <a name="module_argocd"></a> [argocd](#module\_argocd) | aws-blueprints/eks-blueprints-addon/aws | 2.0.0 |
