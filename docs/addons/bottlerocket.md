...
To see a complete working example, see the [`bottlerocket`](https://github.com/aws-blueprints/terraform-aws-eks-blueprints/tree/main/patterns/bottlerocket) Blueprints Pattern.
